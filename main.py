...
def main():
    ...
    parser_compile.add_argument('-n', '--names', type = str, default = 'a.names', help = 'The file to write the public entry names to. (Default: a.names)')
    ...
    parser_prove.add_argument('-a', '--args', action = StoreKVPairs, nargs = '*', default = {}, help = 'The arguments to the program, in the form of key=value pairs.')
    ...
    parser_verif.add_argument('-n', '--names', type = str, default = 'a.names', help = 'The file to read the public entry names from. (Default: a.names)')
    ...
    if args.command == 'compile':
        ...
        with open(args.names, 'wb') as names:
            print('Writing public entry names to:', args.names)
