...
def main():
    ...
    if args.command == 'compile':
        ...
        # A malicious attacker can tamper with the above files, allowing them to execute arbitrary code when the user
        # recovers the data by calling dill.loads, so it is recommended that the party executing the compilation sign
        # these files before distributing them.
